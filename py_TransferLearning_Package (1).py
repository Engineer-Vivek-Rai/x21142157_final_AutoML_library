...
def modeling(img_features,img_labels, num_classes, batch_size = 32, epochs = 25):
    """
    ...
    num_classes = number of classes preset. We can check that using the DataFrame.value_counts()
    Thus,
    img_features = X
    img_labels = y
    ...
    accuracy_vgg = balanced_accuracy_score(y_true, yhat_valid_vgg)
    ...
    accuracy_res = balanced_accuracy_score(y_true, yhat_valid_res)
    ...
    accuracy_mob = balanced_accuracy_score(y_true, yhat_valid_mob)
    ...
    accuracy_eff = balanced_accuracy_score(y_true, yhat_valid_eff)
    ...
    accuracy_den = balanced_accuracy_score(y_true, yhat_valid_den)
    ...
    data = {
    'Model': ['VGGNet19', 'ResNet50', 'MobileNetV2', 'EfficientNet-B7', 'DenseNet-121'],
